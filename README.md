A very basic GUI for the [larkm](https://github.com/mjordan/larkm) ARK manager/resolver that allows creating, editing, and deleting ARKs. larkm Manager uses the [Streamlit](https://streamlit.io/) application framework. larkm Manager can be run  locally (i.e., on the client's computer) and not on a web server.
